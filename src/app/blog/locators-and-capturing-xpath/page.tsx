...
export default function BlogPostPage() {
  ...
  const mcpConfigImage = PlaceHolderImages.find(p => p.id === 'playwright-mcp-config');
  const mcpToolsImage = PlaceHolderImages.find(p => p.id === 'playwright-mcp-tools');
  const mcpChatImage = PlaceHolderImages.find(p => p.id === 'playwright-mcp-chat');
  const mcpRunnerImage = PlaceHolderImages.find(p => p.id === 'playwright-mcp-runner');
  const mcpReportImage = PlaceHolderImages.find(p => p.id === 'playwright-mcp-report');
  ...
  "servers": {
    "playwright": {
      ...
      "args": ["@playwright/mcp@latest"]
            ...
            {mcpConfigImage && (
              <div className="my-8">
                <Image src={mcpConfigImage.imageUrl} alt="Playwright MCP Config" width={800} height={400} className="w-full rounded-lg object-cover shadow-lg" data-ai-hint={mcpConfigImage.imageHint} />
              </div>
            )}
  ...
  "chat.tools.autoApprove": true
            ...
            {mcpToolsImage && (
              <div className="my-8">
                <Image src={mcpToolsImage.imageUrl} alt="Playwright MCP Agent Tools" width={800} height={300} className="w-full rounded-lg object-cover shadow-lg" data-ai-hint={mcpToolsImage.imageHint} />
              </div>
            )}
            ...
            {mcpChatImage && (
              <div className="my-8">
                <Image src={mcpChatImage.imageUrl} alt="Playwright MCP Agent Chat" width={800} height={400} className="w-full rounded-lg object-cover shadow-lg" data-ai-hint={mcpChatImage.imageHint} />
              </div>
            )}
            ...
            {mcpRunnerImage && (
              <div className="my-8">
                <Image src={mcpRunnerImage.imageUrl} alt="Playwright MCP Test Runner" width={800} height={400} className="w-full rounded-lg object-cover shadow-lg" data-ai-hint={mcpRunnerImage.imageHint} />
              </div>
            )}
            ...
            {mcpReportImage && (
              <div className="my-8">
                <Image src={mcpReportImage.imageUrl} alt="Playwright MCP Test Report" width={800} height={400} className="w-full rounded-lg object-cover shadow-lg" data-ai-hint={mcpReportImage.imageHint} />
              </div>
            )}
