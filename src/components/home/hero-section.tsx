...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-screen min-h-[600px] w-full flex items-start pt-24 md:pt-0 md:items-center text-center md:text-left md:min-h-[700px] overflow-hidden md:justify-start">
